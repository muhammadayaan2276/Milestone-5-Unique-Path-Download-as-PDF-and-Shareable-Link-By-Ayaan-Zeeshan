    ...
    if (profilePictureInput && nameElement && emailElement && phoneElement && educationElement && experienceElement && skillsElement) {
        ...
        if (profilePictureFile) {
            ...
            reader_1.onloadend = function () {
                var _this = this;
                profilePictureURL_1 = reader_1.result;
                var resumeOutput = "\n                    <html>\n                    <head>\n                        <style>\n                            body {\n                                font-family: 'Times New Roman', Times, serif;\n                                margin: 20px;\n                                padding: 0%;\n                                background-color: antiquewhite;\n                            }\n                            h1 {\n                                text-align: center;\n                                color: brown;\n                            }\n                            .profilePicture {\n                                width: 150px;\n                                height: 150px;\n                                border-radius: 50%;\n                                object-fit: cover;\n                                display: block;\n                                margin: 0 auto;\n                                border: 10px solid brown;\n                                box-shadow: 0 0 8px 8px rgba(161, 19, 19, 0.5);\n                            }\n                            .contact-info {\n                                font-size: 1.2rem;\n                            }\n                            .user-input {\n                                font-weight: bold;\n                            }\n                            h3 {\n                                color: #8B0000;\n                            }\n                            .education-output,\n                            .experience-output,\n                            .skills-output {\n                                font-size: 1.1rem;\n                            }\n                        </style>\n                    </head>\n                    <body>\n                        <h1>Resume</h1>\n                        <br>\n                        ".concat(profilePictureURL_1 ? "<img src=\"".concat(profilePictureURL_1, "\" alt=\"Profile Picture\" class=\"profilePicture\">") : '', "\n                        <br>\n                        <p class=\"contact-info\"><strong>Name:</strong> <span class=\"user-input\">").concat(name_1, "</span></p>\n                        <p class=\"contact-info\"><strong>Email:</strong> <span class=\"user-input\">").concat(email_1, "</span></p>\n                        <p class=\"contact-info\"><strong>Phone Number:</strong> <span class=\"user-input\">").concat(phone_1, "</span></p>\n                        <br>\n                        <h3>Education</h3>\n                        <p class=\"education-output\">").concat(education_1, "</p>\n                        <h3>Work Experience</h3>\n                        <p class=\"experience-output\">").concat(experience_1, "</p>\n                        <h3>Skills</h3>\n                        <p class=\"skills-output\">").concat(skills_1, "</p>\n                    </body>\n                    </html>\n                ");
